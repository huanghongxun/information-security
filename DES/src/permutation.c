...
const permutation_t PERM_SWITCH = {
    64,
    64,
    {
...
const int (*S_BOX[8])[4][16] = {
    &S1_BOX, &S2_BOX, &S3_BOX, &S4_BOX, &S5_BOX, &S6_BOX, &S7_BOX, &S8_BOX
};
...
const permutation_t PERM_REMOVE_PARITY = {
    64,
    56,
    {
         0,  1,  2,  3,  4,  5,  6,
